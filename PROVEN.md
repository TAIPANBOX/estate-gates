...
| SUP-4: Scorecard on the 1.0 candidates | api.scorecard.dev has nothing indexed for any TAIPANBOX repository and the workflow's own SARIF carries one rule; readable after the Sunday 07:41Z run | 2026-09-13 |
...
| R1, R2, R3 of the 1.0 plan | Nothing on a Linux box, a cluster or a paid provider yet; the four R1 scenarios above ran on the Mac | 2026-09-13 |
