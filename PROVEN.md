...
(seven on R0, seven on R1, fourteen on R2 GCP).
...
| R2 AWS and R3 of the 1.0 plan | Not started: the AWS leg has its own cost line and its own go; no paid provider matrix yet | 2026-09-13 |
